...
# --- CONFIGURAÇÃO DE EMAIL (BREVO/GMAIL/RESEND) ---
...
# Converte a string 'True' do env file para o booleano True do Python
# Se não estiver definido, assume os padrões seguros para porta 587
